          ...
          children: [
            {
              ...
              customFields: [
                ...
                { id: "cf13", name: "自己紹介", value: "Webアプリケーション開発を担当しています。", type: "textarea" },
              ],
            },
          ],
      ...
      children: [
        {
          ...
          nodeType: "type-era",
          customFields: [
            { id: "rb-cf1", name: "説明", value: "ロックンロールからハードロックへの発展期", type: "textarea" },
          ...
          children: [
            {
              ...
              nodeType: "type-genre",
              customFields: [
                { id: "rb-cf3", name: "説明", value: "幻覚剤の影響を受けた実験的な音楽", type: "textarea" },
                { id: "rb-cf4", name: "特徴", value: "長いインプロビゼーション、エフェクト多用", type: "textarea" },
              ],
              children: [
                {
                  id: "rb4",
                  ...
                  customFields: [
                    { id: "rb-cf5", name: "結成年", value: "1965", type: "text" },
                    {
                      ...
                      name: "メンバー",
                      value:
                        "シド・バレット、ロジャー・ウォーターズ、デヴィッド・ギルモア、リチャード・ライト、ニック・メイスン",
                      type: "textarea",
                    },
                    {
                      id: "rb-cf7",
                    ...
                    { id: "rb-cf8", name: "公式サイト", value: "https://www.pinkfloyd.com/", type: "link" },
                  ],
                  children: [],
                },
              ],
            },
            {
              ...
              icon: "🎵",
              nodeType: "type-genre",
              customFields: [{ id: "rb-cf9", name: "説明", value: "イギリス発のロックムーブメント", type: "textarea" }],
              children: [
                {
                  id: "rb6",
                  name: "ザ・ビートルズ",
                  ...
                  customFields: [
                    ...
                    { id: "rb-cf12", name: "代表曲", value: "Hey Jude, Let It Be, Yesterday", type: "textarea" },
                  ],
                  children: [],
                },
                {
        ...
        },
        {
          ...
          nodeType: "type-era",
          customFields: [
            { id: "rb-cf16", name: "説明", value: "ハードロック、プログレッシブロックの黄金期", type: "textarea" },
          ...
          children: [
            {
              ...
              nodeType: "type-genre",
              customFields: [
                { id: "rb-cf18", name: "説明", value: "より重厚なサウンドと攻撃的な演奏", type: "textarea" },
              ],
              children: [
                {
                  id: "rb10",
                ...
                },
                {
                  ...
                  customFields: [
                    ...
                    { id: "rb-cf24", name: "代表曲", value: "Smoke on the Water, Highway Star", type: "textarea" },
                  ],
                  children: [],
                },
              ],
              ...
              children: [
                {
                  ...
                  customFields: [
                    { id: "rb-cf26", name: "結成年", value: "1968", type: "text" },
                    {
                      ...
                      name: "メンバー",
                      value:
                        "ジョン・アンダーソン、スティーブ・ハウ、クリス・スクワイア、リック・ウェイクマン、アラン・ホワイト",
                      type: "textarea",
                    },
                    { id: "rb-cf28", name: "代表曲", value: "Roundabout, Owner of a Lonely Heart", type: "textarea" },
                  ],
                  children: [],
                },
              ],
          ...
          children: [
            {
              ...
              nodeType: "type-genre",
              customFields: [
                { id: "rb-cf31", name: "説明", value: "より重く、速く、攻撃的なロック", type: "textarea" },
              ],
              children: [
                {
                  id: "rb16",
                ...
                },
                {
                  ...
                  customFields: [
                    { id: "rb-cf35", name: "結成年", value: "1975", type: "text" },
                    {
                      ...
                      name: "メンバー",
                      value:
                        "ブルース・ディッキンソン、スティーブ・ハリス、デイヴ・マーレイ、エイドリアン・スミス、ニコ・マクブレイン、ヤニック・ガーズ",
                      type: "textarea",
                    },
                    {
                      id: "rb-cf37",
          ...
          children: [
            {
              ...
              customFields: [
                ...
                { id: "tk-cf6", name: "主な業績", value: "江戸幕府の創設、大坂の陣での豊臣氏の滅亡", type: "textarea" },
              ],
              children: [],
            },
            {
              ...
              customFields: [
                ...
                { id: "tk-cf10", name: "主な業績", value: "武家諸法度の制定、キリスト教の禁止", type: "textarea" },
              ],
              children: [],
            },
            {
              ...
              customFields: [
                ...
                { id: "tk-cf14", name: "主な業績", value: "鎖国政策の完成、参勤交代制度の確立", type: "textarea" },
              ],
              children: [],
            },
          ],
          ...
          children: [
            ...
            },
            {
              ...
              customFields: [
                ...
                { id: "tk-cf24", name: "主な業績", value: "生類憐みの令、元禄文化の発展", type: "textarea" },
              ],
              children: [
                {
                  id: "tk9",
                  ...
                  customFields: [
                    ...
                    { id: "tk-cf27", name: "影響", value: "町人文化の発展と浮世絵の隆盛", type: "textarea" },
                  ],
                  children: [],
                },
              ],
          ...
          children: [
            {
              ...
              customFields: [
                ...
                { id: "tk-cf33", name: "主な業績", value: "寛政の改革、化政文化の発展", type: "textarea" },
              ],
              children: [],
            },
            {
              ...
              customFields: [
                ...
                { id: "tk-cf37", name: "主な業績", value: "大政奉還による幕府の終焉", type: "textarea" },
              ],
              children: [
                {
                  id: "tk13",
                  ...
                  customFields: [
                    ...
                    { id: "tk-cf39", name: "詳細", value: "徳川慶喜が政権を朝廷に返上", type: "textarea" },
                    { id: "tk-cf40", name: "影響", value: "江戸幕府の終焉と明治維新の始まり", type: "textarea" },
                  ],
                  children: [],
                },
              ],
      ...
      children: [
        {
          ...
          customFields: [{ id: "co-cf1", name: "責任範囲", value: "会社全体の経営戦略と意思決定", type: "textarea" }],
          children: [
            {
              id: "co3",
              name: "山田太郎",
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              icon: "👔",
              nodeType: "type-position",
              customFields: [{ id: "co-cf17", name: "責任範囲", value: "大企業向け営業活動", type: "textarea" }],
              children: [
                {
                  id: "co8",
                  name: "田中三郎",
          ...
          children: [
            {
              ...
              customFields: [
                ...
                { id: "co-cf27", name: "スキル", value: "Java, Python, クラウドアーキテクチャ", type: "textarea" },
              ],
              children: [],
            },
            {
              ...
              customFields: [
                ...
                { id: "co-cf32", name: "概要", value: "次世代クラウドサービスの開発", type: "textarea" },
              ],
              children: [],
            },
          ],
