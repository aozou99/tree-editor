...
import type { NodeType, CustomFieldDefinition } from "./tree-editor"
            ...
            <>
              <div className="mb-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditingNodeType((prev) => (prev ? { ...prev, name: e.target.value } : null))}
                ...
                <div className="flex gap-2 items-center">
                  <div className="flex-1 border rounded-md p-2 flex items-center">
                    ...
                    {!editingNodeType?.icon && (
                      <div className="text-sm text-muted-foreground ml-2">アイコンが設定されていません</div>
                    )}
                  </div>
                  <Button
                    variant="outline"
                  ...
                  <EmojiPicker onEmojiSelect={handleUpdateIcon} currentEmoji={editingNodeType?.icon} />
                  <input
                    type="file"
                    ref={fileInputRef}
                    className="hidden"
                    ...
                    {editingNodeType?.fieldDefinitions.map((field) => (
                      <div key={field.id} className="flex items-start gap-2 border rounded-md p-2">
                        <div className="grid grid-cols-2 gap-2 flex-1">
                          <div>
                            <Label htmlFor={`field-name-${field.id}`} className="text-xs block mb-1">
                              フィールド名
                            </Label>
                            <Input
                          ...
                          <div>
                            <Label htmlFor={`field-type-${field.id}`} className="text-xs block mb-1">
                              タイプ
                            </Label>
                            <Select
                              value={field.type}
