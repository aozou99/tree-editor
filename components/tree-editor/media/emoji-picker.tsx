...
export function EmojiPicker({ onEmojiSelect, currentEmoji }: EmojiPickerProps) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div ref={modalRef} className="absolute z-50 top-full right-0 mt-1 w-80 bg-white border rounded-md shadow-md">
          ...
          {searchQuery ? (
            <ScrollArea className="h-60 p-2">
              ...
              {filteredEmojis.length === 0 && (
                <div className="text-center py-4 text-sm text-muted-foreground">絵文字が見つかりません</div>
              )}
            </ScrollArea>
          ) : (
            <div>
