...
export function saveWorkspaceList(workspaceList: WorkspaceList): void {
    try {
        ...
        console.error(i18n.t('workspace.errors.saveFailed'), error);
    }
}
...
export function loadWorkspaceList(): WorkspaceList {
    try {
        ...
        console.error(i18n.t('workspace.errors.loadFailed'), error);
    }
...
export function saveWorkspace(workspace: Workspace): void {
    try {
        ...
        console.error(`${i18n.t('workspace.errors.saveFailed')} ${workspace.id}:`, error);
    }
}
...
export function loadWorkspace(workspaceId: string): Workspace | null {
    try {
        ...
        console.error(`${i18n.t('workspace.errors.loadFailed')} ${workspaceId}:`, error);
    }
    return null;
}
...
export function createWorkspace(name: string, initialData?: Partial<Workspace>): Workspace {
    ...
    const newWorkspace: Workspace = {
        ...
        treeTitle: initialData?.treeTitle || i18n.t('workspace.defaultTreeName'),
    };
...
export function renameWorkspace(workspaceId: string, newName: string): boolean {
    try {
        ...
        console.error(`${i18n.t('workspace.errors.renameFailed')} ${workspaceId}:`, error);
        return false;
    }
}
...
export function deleteWorkspace(workspaceId: string): boolean {
    try {
        ...
        console.error(`${i18n.t('workspace.errors.deleteFailed')} ${workspaceId}:`, error);
        return false;
    }
}
...
export function setActiveWorkspace(workspaceId: string): boolean {
    try {
        ...
        console.error(`${i18n.t('workspace.errors.switchFailed')}:`, error);
        return false;
    }
}
...
export function clearAllWorkspaces(): void {
    try {
        ...
        console.error(i18n.t('workspace.errors.deleteFailed'), error);
    }
}
