# Tree Editor - アプリケーション概要とアーキテクチャ

## 概要

Tree Editor は、階層構造データを視覚的に編集・管理するための Web アプリケーションです。ドラッグ&ドロップ操作による直感的なインターフェースを提供し、組織図、プロジェクト構造、ナレッジベース、マインドマップなど、様々な階層データの管理に使用できます。
